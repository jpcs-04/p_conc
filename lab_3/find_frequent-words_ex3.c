...
void threads_init_join()
{
    ...
    argthreads arg_threads[2];

    arg_threads[0].c_start ='a';
    arg_threads[0].c_end ='m';
    pthread_create(&threads_id[0], NULL, find_unique_words_letters, &arg_threads[0]);
    arg_threads[1].c_start ='n';
    arg_threads[1].c_end ='z';
    pthread_create(&threads_id[1], NULL, find_unique_words_letters, &arg_threads[1]);
